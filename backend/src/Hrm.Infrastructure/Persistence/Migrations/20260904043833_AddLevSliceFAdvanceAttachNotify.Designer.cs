...
namespace Hrm.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260904043833_AddLevSliceFAdvanceAttachNotify")]
    partial class AddLevSliceFAdvanceAttachNotify
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hrm.Domain.Leave.Entities.LeaveNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Hrm.Domain.Leave.Entities.LeaveRequest", b =>
                {
                    ...
                    b.Property<bool>("AttachmentMatchesCompanyTemplate")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Hrm.Domain.Leave.Entities.LeaveType", b =>
                {
                    ...
                    b.Property<bool>("RequiresCompanyTemplateFile")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Hrm.Domain.Lifecycle.Entities.LifOnChecklistTick", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Hrm.Domain.Lifecycle.Entities.LifOnboardingCase", b =>
                {
                    ...
                    b.Property<bool>("ChatProvisioned")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("ChatProvisionedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<bool>("CrmSpProvisioned")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("CrmSpProvisionedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<bool>("EmailCtyProvisioned")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("EmailCtyProvisionedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<bool>("GitProvisioned")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("GitProvisionedAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Hrm.Domain.Payroll.Entities.PayRegulation", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Code = "TNCN_PERSONAL_DEDUCTION",
                            DecimalValue = 11000000m,
                            Name = "Giảm trừ bản thân TNCN"
                        },
                        new
                        {
                            Id = new Guid("d8d8d8d8-d8d8-d8d8-d8d8-d8d8d8d8d8d8"),
                            Code = "TNCN_DEPENDENT_UNIT",
                            DecimalValue = 4400000m,
