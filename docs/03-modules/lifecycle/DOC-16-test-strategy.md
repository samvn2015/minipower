...
|-------|-------|----------|-------|------|-----|-----|
| LIF-TC-001 | Checklist on; thiếu Must | Chặn hoàn all | E2E | Unhappy | Must | |
| LIF-TC-002 | Cấp TK lúc on | TK tạo | API | Happy | Must | |
| LIF-TC-003 | N = ngày LV cuối | Đúng N | API | Happy | Must | |
| LIF-TC-004 | NV không kích N+3 | 403 | API | Unhappy | Must | |
| LIF-TC-005 | Khóa Git N+3 lịch | Đúng mốc | API | Happy | Must | |
| LIF-TC-006 | CRM SP cùng mốc | Cùng N+3 | API | Happy | Must | |
| LIF-TC-007 | Khóa trước N+3 | Cấm | API | Unhappy | Must | |
| LIF-TC-008 | HR 403 khóa Git | 403; secret IT | API | Unhappy | Must | |
| LIF-TC-009 | Checklist off | OK | E2E | Happy | Must | |
| LIF-TC-010 | Không CRM sales | 0 call INT-006 | E2E | Unhappy | Must | |
| LIF-TC-011 | Chat theo master | Should | E2E | Happy | Should | |
| LIF-TC-012 | Đủ LIF-SCR-001…006 | Có màn | E2E | Happy | Must | |
| LIF-TC-013 | Hiện N và N+3 | UI đúng | E2E | Happy | Must | |
| LIF-TC-014 | Audit khóa sớm | Log | API | Happy | Must | |
| LIF-TC-015 | NV 403 ghi N job | 403 | API | Unhappy | Must | |
| LIF-TC-016 | Không nút CRM sales | Không UI | E2E | Happy | Must | |
| LIF-TC-NFR-001 | HR không credential Git | Pass | E2E | Unhappy | Must | |
| LIF-TC-NFR-002 | Audit N / khóa Git-CRM | Log | API | Happy | Must | |
| LIF-TC-HA-001 | Job N+3 không chạy DR | Count 0 | HA | Unhappy | Must | |

## 3. Chi tiết test case

Path: `GET /lif/cases/{employeeId}`, `POST /lif/cases/{employeeId}/locks` (job/IT · INT-004/005). Job **chỉ Active** (ADR-003). N+3 = N + 3 **ngày lịch** (nháp DOC-07). Secret Git = IT, không HR.
